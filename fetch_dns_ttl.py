...
def fetch_domain_ns(domain,server = '223.5.5.5'):
    """
    获取域名的NS记录
    """
...
def main(domain):
    ...
    for check_domain in mal_domains:
        ...
        return [g_ips,g_ips_ttl,g_ns,g_ns_ttl,g_cnames,g_cnames_ttl,time_now]
